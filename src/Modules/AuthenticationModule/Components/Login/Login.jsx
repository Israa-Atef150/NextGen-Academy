    ...
    <>
      <section className="bg-gray-50 dark:bg-gray-900 background">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 text-right" dir="rtl">
          <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white flex-row-reverse">
            <img className="w-8 h-8 ml-2" src=".\src\assets\imgs\logo.jpg" alt="logo" />
            إشراق
          </a>
